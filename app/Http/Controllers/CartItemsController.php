...
class CartItemsController extends Controller
{
    ...
    public function store(Request $request)
    {
        CartItem::updateOrCreate(
          ...
          return redirect('/items')->with('flash_message', 'Added item on your cart');
    }
    ...
    public function update(Request $request, CartItem $cartItem)
    {
        ...
        $cartItem->save();
        return redirect('cartitem')->with('flash_message', 'Update cart');
    }
    ...
    {
        $cartItem->delete();
        return redirect('cartitem')->with('flash_message', 'Removed item from cart');
    }
}
